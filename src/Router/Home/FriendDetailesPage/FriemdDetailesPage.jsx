...
const FriendDetailesPage = () => {
  ...
  const handleCallFriend = () => {
    ...
    alert("Call going friend successfully added timeline");
  };
  ...
  return (
    <div className="bg-[#E9E9E9]">
      <div className="w-10/12 mx-auto py-10 flex gap-3">
        <div>
        ...
        <div>
          <div className="flex justify-between gap-3 text-center w-full">
            ...
            <div className="shadow-sm bg-white p-4 rounded-sm">
              <span className="text-2xl font-bold">{axceptedFriend.goal}</span>
          ...
          <div>
            <div className="shadow-sm bg-white  p-4 rounded-sm w-full mt-4">
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <NavLink onClick={() => handleMessegeFriend()}
                  to={`/timeline`}
                ...
                <NavLink onClick={() => handleVideoFriend()}
                  to={`/timeline`}
                  className="shadow-sm w-full bg-gray-100 p-4 rounded-sm text-center"
                >
                  <span className="text-2xl font-bold">
